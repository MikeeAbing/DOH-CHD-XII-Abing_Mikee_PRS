...
<div class="login-box">
  <div class="login-logo mb-4">
    <img src="dist/img/icon.jpg" id="system-logo">
    <div class="text-center h2 mb-0">Patient Registration System</div>
  </div>
  <!-- /.login-logo -->
  <div class="card card-outline card-success rounded-0 shadow">
    <div class="card-body login-card-body">
      ...
      <form method="post">
        ...
        <div class="row">
          <div class="col-12">
            <button name="login" type="submit" class="btn btn-success rounded-0 btn-block">Sign In</button>
          </div>
          <!-- /.col -->
        </div>
